<div>
    <style>
        ...
        .wishlisted{
            ...
            background-color: hsl(330, 80%, 61%) !important;
                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy == 'Default Sorting' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrder('Default Sorting')">Default Sorting</a></li>
                                            <li><a class="{{$orderBy == 'Price: Low to High' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrder('Price: Low to High')">Price: Low to High</a></li>
                                            <li><a class="{{$orderBy == 'Price: High to Low' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrder('Price: High to Low')">Price: High to Low</a></li>
                                            <li><a class="{{$orderBy == 'Sort By Newest' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrder('Sort By Newest')">Sort By Newest</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
